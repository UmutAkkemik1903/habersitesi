 ...
 <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="slider.php"><i class="fa fa-image"></i>Slider Ayarları <span class="label label-success pull-right"></span></a></li>
                </ul>
                <ul class="nav side-menu">
                  <li><a href="resim.php"><i class="fa fa-image"></i>Resim Galeri <span class="label label-success pull-right"></span></a></li>
                </ul>
                <ul class="nav side-menu">
                  <li><a href="menu.php"><i class="fa fa-list"></i>Menü Ayarları <span class="label label-success pull-right"></span></a></li>
                </ul>
                <ul class="nav side-menu">
                  <li><a href="icerik.php"><i class="fa fa-file-text"></i>İçerik Ayarları <span class="label label-success pull-right"></span></a></li>
                </ul>
                <ul class="nav side-menu">
