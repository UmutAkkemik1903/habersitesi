...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>İletişim Ayarları <small> <?php
     ...
     <?php }  elseif (@$_GET['durum']=='no') {?>
      ...
      <div class="clearfix"></div>
                ...
                <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Adres Bilginiz <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" name="iletisimkaydet" class="btn btn-primary">Güncelle</button>
                        </div>
</div>
</div>
</div>
