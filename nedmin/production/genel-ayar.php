    ...
    <div class="x_title">
     ...
     <?php }  elseif (@$_GET['durum']=='no') {?>
      ...
      <div class="clearfix"></div>
                ...
                <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Logo Ekle <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <input type="hidden" name="logo-sil" value="<?php  echo $ayarcek['ayar_logo']; ?>">
                      <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         
                          <button type="submit" name="logoduzen" class="btn btn-primary">Güncelle</button>
                        </div>
