		...
		<div class="body">
			<header id="header" class="header-no-border-bottom" data-plugin-options='{"stickyEnabled": true, "stickyEnableOnBoxed": true, "stickyEnableOnMobile": true, "stickyStartAt": 115, "stickySetTop": "-115px", "stickyChangeLogo": false}'>
				<div class="header-body">
					...
					<div class="header-container header-nav header-nav-bar" style="!important;background-color: #040356">
						<div class="container">
							...
							<div class="header-search visible-lg">
								<form id="searchForm" action="arama.php" method="get">
									<div class="input-group">
										<input type="text" class="form-control" name="aranan" id="q" placeholder="Arama..." required>
